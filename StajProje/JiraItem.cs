...
namespace StajProje
{
    ...
    {
        public string Type { get; set; }
        public List<Content2> Content_ { get; set; }
...
public class Item2
{
    ...
    public string FromString { get; set; }
    public string To { get; set; }
    public string ToString2 { get; set; }
...
public class Issuerestrictions2
{

}

public class Issuerestriction2
{
    public Issuerestrictions İssuerestrictions { get; set; }
    public bool ShouldDisplay { get; set; }
...
public class NonEditableReason2
{
    public string Reason { get; set; }
    public string Message { get; set; }
...
public class Customfield100182
{
    public bool HasEpicLinkFieldDependency { get; set; }
    public bool ShowField { get; set; }
    public NonEditableReason NonEditableReason { get; set; }
    ...
    public class Reporter2
{
    ...
    public string DisplayName { get; set; }
        ...
        public string TimeZone { get; set; }
    public string AccountType { get; set; }
        public bool Active1 { get => active1; set => active1 = value; }
    }
